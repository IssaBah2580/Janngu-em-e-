...
export const GRAMMAR_COMPILATION: GrammarCategory[] = [
  ...
  {
    id: 'possessives',
    title: { en: "Possessive Adjectives", fr: "Adjectifs Possessifs", pulaar: "Jeyi" },
    sections: [
      {
